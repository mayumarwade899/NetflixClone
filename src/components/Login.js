...
const Login = () => {
  ...
  return (
    <div>
      ...
      <form className="absolute rounded-md text-white bg-black bg-opacity-80 w-[30%] p-12 my-28 mx-auto right-0 left-0">
        ...
        />
        <button className="p-2 my-4 bg-[#e50914] w-full text-lg rounded-md">
          {isSignIn ? "Sign In" : "Sign Up"}
        </button>
        <p className="text-right cursor-pointer">Forgot password?</p>
        {isSignIn && <p className="text-[#b1b2a8] my-8">
          New to Netflix? {" "}
          <span
